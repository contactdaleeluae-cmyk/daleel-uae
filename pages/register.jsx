  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="List your UAE business on Daleel UAE. Starting from AED 500/year. Get found by thousands of UAE customers."
        />
      </Head>
      ...
      <main>
        ...
        >
          ...
          <div
            className="absolute top-0 left-1/3 w-96 h-96 rounded-full opacity-10 blur-3xl"
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-5 leading-tight">
              ...
              <span style={{ color: '#0D9488' }}>
                Thousands of UAE Customers
              </span>
            </h1>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-10">
              Join UAE&apos;s most trusted business directory and watch your phone ring
            </p>
        ...
        <section className="py-16 bg-white border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-gray-500 mb-10">
              Most businesses recover their listing fee within the first week
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-2">
              {[
                ...
                { arrow: true },
                {
                  step: '2',
                  label: 'Get Found',
                  sub: 'By UAE customers',
                  color: '#0D9488',
                },
                { arrow: true },
                {
                  step: '3',
                  label: 'One New Client',
                  sub: '= AED 500+',
                  color: '#0D9488',
                },
                { arrow: true },
                ...
                item.arrow ? (
                  <HiArrowRight
                    key={i}
                    className="w-5 h-5 text-gray-300 flex-shrink-0 hidden sm:block"
                  />
                ) : (
                  <div
                    key={i}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {tiers.map((tier) => (
                <div
                  ...
                  className={`tier-card relative bg-white rounded-3xl p-8 cursor-pointer transition-all duration-300 ${
                  ...
                  style={
                    selectedTier === tier.id
                      ? { ringColor: tier.color, boxShadow: `0 20px 60px ${tier.color}25` }
                      : {}
                  }
                >
                  {/* Popular Badge */}
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Al Noor AC Services"
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm transition-all"
                  style={{ color: '#0F172A' }}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm transition-all disabled:opacity-50"
                    style={{ color: '#0F172A' }}
                  >
                    <option value="">
                      {form.emirate ? 'Select Area' : 'Select Emirate first'}
                    </option>
                    {areas.map((a) => (
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Describe your business, what you offer, and what makes you stand out..."
                  rows={4}
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm resize-none transition-all"
                  style={{ color: '#0F172A' }}
                />
              </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1.5">
                  Key Services <span className="text-red-500">*</span>
                </label>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[1, 2, 3].map((num) => (
                    <input
                      key={num}
                      name={`key_service_${num}`}
                      type="text"
                      value={form[`key_service_${num}`]}
                      onChange={handleChange}
                ...
                <p className="text-xs text-gray-400 mt-1.5">
                  e.g. AC Installation, AC Repair, Duct Cleaning
                </p>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="List any other services you offer..."
                  rows={3}
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm resize-none transition-all"
                  style={{ color: '#0F172A' }}
                />
              ...
              <div className="border-t border-gray-100 pt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div
                      className="relative border-2 border-dashed rounded-xl p-4 text-center cursor-pointer hover:border-teal-400 transition-colors"
              ...
              <p className="text-center text-xs text-gray-400">
                By submitting, you agree to our Terms & Conditions. Your listing will be reviewed and activated within 2 hours of payment confirmation.
              </p>
            </form>
          </div>
        </section>
