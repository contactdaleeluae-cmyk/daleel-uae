  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Complete your payment to activate your Daleel UAE business listing."
        />
      </Head>
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-gray-300 text-lg">
              Complete your payment below to activate your listing
            </p>
          </div>
        </section>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-2 border-b border-gray-50">
                  ...
                  <span
                    className="text-sm font-bold capitalize px-3 py-0.5 rounded-full text-white"
